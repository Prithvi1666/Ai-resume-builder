  ...
  return (
    <div className='space-y-6'>
         <div className='flex items-center justify-between'>
            <div>
                <h3 className='flex items-center gap-2 text-lg font-semibold text-gray-900'> Professinal Experience </h3>
                <p className='text0sm text-gray-500'>Add your job experience</p>
            </div>
            <button onClick={addExperience} className='flex items-center gap-2 px-3 py-1 text-sm bg-green-100 text-green-700 rounded-lg 
                    ...
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className=' grid md:grid-cols-2 gap-3'>
                            ...
                            <input value={experience.company || ""} onChange={(e)=>updateExperience(index, "company", e.target.value)} 
                             ...
                             type='text' placeholder='Job Tittle' className='px-3 py-2 text-sm rounded-lg'/>
                        ...
                        <label className='flex items-center gap-2'>
                            <input type="checkbox" checked={experience.is_current || false} onChange={(e)=>{updateExperience(index, "is_current", 
                             e.target.checked ? true : false); }} className='rounded border-gray-300 text-blue-600 focus:ring-blue-500'/>
                        ...
                        <div className='space-y-2'>
                            <div className='flex items-center justify-between '>
                                ...
                                className='flex items-centergap-1 px-2 py-1 text-xs bg-purple-100 text-purple-700 rounded
                            ...
                            placeholder='Descreibe your key responsibilities and achievements...'/>
                        </div>
                    </div>
                ))}
            </div>
