...
const ProjectForm = ({ data = [], onChange}) => {
    ...
    const removeProject = (index)=>{
        const update = projects.filter((_, i)=> i !== index);
        onChange(update)
    }
  ...
  return (
   <div >
         <div className='flex items-center justify-between'>
            ...
            <button onClick={addProject} className='flex items-center gap-2 px-3 py-1 text-sm bg-green-100 text-green-700 rounded-lg 
