    ...
    <div className='space-y-4'>
        ...
        <div className='flex gap-2 '>
            <input type="text" placeholder='Enter a skill (e.g., JavaScript, Project Management)' className='flex-1 px-3 py-2 text-sm'
             ...
             text-white rounded-lg hover:bg-blue-700 transition-ccolors disabled:opacity-50'>
        ...
        <div className='bg-blue-50 p-3 rounded-lg'> 
            <p className='text-sm text-blue-800'><strong>Tip:</strong> Add 88-12 relevant skills. Include both technical skills (programming languages, tools)
